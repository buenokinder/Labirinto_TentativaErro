...
public class Labirinto {
	...
	public boolean encontarCaminho(Posicao _inicial, Posicao _final){
		...
		if(this.encontarCaminho(_inicial.Mover(Movimento.Direta), _final))
		{
			this.mapa.mapa[_inicial.linha][_inicial.coluna] = TipoElementoLabirinto.PercorridoCorreto.asChar();
			return true;
		}
		if(this.encontarCaminho(_inicial.Mover(Movimento.Esquerda), _final))
		{
			this.mapa.mapa[_inicial.linha][_inicial.coluna] = TipoElementoLabirinto.PercorridoCorreto.asChar();
			return true;
		}
		
		if(this.encontarCaminho(_inicial.Mover(Movimento.Cima), _final))
		{
			this.mapa.mapa[_inicial.linha][_inicial.coluna] = TipoElementoLabirinto.PercorridoCorreto.asChar();
			return true;
		}
		
		if(this.encontarCaminho(_inicial.Mover(Movimento.Baixo), _final))
		{
			this.mapa.mapa[_inicial.linha][_inicial.coluna] = TipoElementoLabirinto.PercorridoCorreto.asChar();
			return true;
		}
